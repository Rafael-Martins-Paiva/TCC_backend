...
from domain.accounts.exceptions.auth_exceptions import InvalidCredentialsError, UserNotFoundError, UserNotVerifiedError
...
@pytest.fixture
def user_data():
    return {"id": 1, "email": "test@example.com", "name": "Test User", "password": "password123", "is_verified": True}
